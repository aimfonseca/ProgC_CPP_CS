 ...
 */
    ...
    */ 
     ...
     */        
        ...
        cout << "Novo endereço de memória, para onde o ponteiro aponta': " << ptr << endl;
        cout << "Valor do elemento do 'array', apontado pelo novo endereço:  " << *ptr << endl;
    ...
    /** A aritmética de ponteiros pode ser aplicada em instruções mais ou menos complexas. */
        cout << "Valor do elemento do 'array', apontado pelo endereço atual: " << *(ptr + 2) << endl;
